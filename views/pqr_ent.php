    ...
    <center>
        <div class="col pqrs">
            ...
            <form action="" method="post" autocomplete="off">
                <?php
                if (!empty($_POST)) {
                    include_once("../models/pqr_ent.php");
                }
                ?>
                <br>
                ...
                <div class="form-row col n_pqr">
                    <div class="col">
                        <input type="text" placeholder="Nit de la empresa:" name="nit_env" id="caja_busq" class="form-control">
                    </div>
                    <div class="col">
                        <p id="existe_ent" class="form-control">⬅ Ingrese datos para buscar</p>
                    </div>
